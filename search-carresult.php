...
$sql = "SELECT id from tblvehicles where tblvehicles.VehiclesBrand=:brand and tblvehicles.BatteryType=:batterytype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':batterytype',$batterytype, PDO::PARAM_STR);
$query->execute();
...
$sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:brand and tblvehicles.BatteryType=:batterytype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':batterytype',$batterytype, PDO::PARAM_STR);
$query->execute();
...
{  ?>
      ...
      <aside class="col-md-3 col-md-pull-9">
		...
		<?php }} ?>
							...
							<div class="form-group select">
								<select class="form-control" name="batterytype">
